...
public class ListUtils
{
    ...
    public static void PrintResults(string headStr1, string headStr2, string expectedStr, string actualStr)
    {
        Console.WriteLine($"   first: {headStr1}");
        Console.WriteLine($"  second: {headStr2}");
        Console.WriteLine($"{new string('.', expectedStr.Length + 10)}");
